...
import ChangePasswordModal from "../../../../../app/modules/Auth/pages/ChangePasswordModal";
import { copyToClipboard } from "../../../../../app/modules/_commons/Utils";
...
export function QuickUser() {
  ...
  const openChangePasswordModal = () => {
    setModel(
      <ChangePasswordModal
        closeModalHandler={() => setModel(null)}
      />
    )
  }
        ...
        >
          <div className="d-flex align-items-center mt-5">
            ...
            >
              ...
              <span className="symbol symbol-25 symbol-light-success">                
            ...
            <div className="d-flex flex-column">
              ...
              <div className="text-muted mt-1">{user?.userRoleMST?.roleName}</div>
              ...
              {/* <button className="btn btn-light-dark btn-bold btn-sm m-1" onClick={() => copyToClipboard(JSON.parse(localStorage.getItem("persist:ticketing-admin-auth"))?.authToken?.replaceAll('"', "") ?? "No Token Copied")}>Copy Token</button> */}
            </div>
          </div>
              ...
              <div className="navi-link">
                ...
                <div className="navi-text">
                  <div className="font-weight-bold">
                    <span style={{cursor: 'pointer'}} onClick={() => openChangePasswordModal()}>Change Password</span>
                  </div>
                </div>
              </div>
            </div>
