...
export const taskAttachmentCrud = new Crud("taskAttachment")
export const taskAttachmentSlice = new BaseSlice(reducerInfo.name, reducerInfo.idFieldName)
export const taskAttachmentActions = new Action(taskAttachmentCrud, taskAttachmentSlice)
