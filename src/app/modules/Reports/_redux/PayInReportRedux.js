...
export const reportsPayInCrud = new Crud("report")
export const reportsPayInSlice = new BaseSlice(reducerInfo.name, reducerInfo.idFieldName)
export const reportsPayInActions = new Actions(reportsPayInCrud, reportsPayInSlice)
