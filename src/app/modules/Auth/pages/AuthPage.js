        ...
        <div className="d-flex flex-column flex-root">
          ...
          >
            ...
            <div
                ...
                style={{
                  backgroundImage: `url(${toAbsoluteUrl("/media/bg/bg-14.png")})`,
            ...
            >
              ...
              <div className="d-flex flex-row-fluid flex-column justify-content-between text-center">
                ...
                <Link to="/" className="flex-column-auto mt-5">
                  <img
                      alt="Logo"
                      className="max-h-120px max-w-90"
                      src={toAbsoluteUrl("/assets/logo/Pippos pizza_name.PNG")}
                      style={{borderRadius:"5px",padding:"5px",backgroundColor:"#fff",boxShadow:"0px 0px 5px #666"}}
                  />
                </Link>
                {/* end:: Aside header */}
                ...
                <div className="flex-column-fluid d-flex flex-column justify-content-center">
                  {/* <h3 className="font-size-h1 mb-5 text-white">
                    Welcome to Ticketing App Admin!
                  </h3> */}
