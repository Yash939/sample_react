...
const BranchDetailModal = ({ id, closeModalHandler, values, setFieldValue, initialValues, editable }) => {
        ...
        >
            <Formik
                ...
                onSubmit={(formValues) => {
                    ...
                    let val = { ...formValues }
                    let organizationBranchDTLList = values?.organizationBranchDTLList ?? []

                    let validated = true

                    organizationBranchDTLList.filter(x => x?.keyField !== val?.keyField).forEach(x => {
                    ...
                    if (editable) {
                        ...
                        const tmporganizationBranchDTLList = mergeArrayWithObject(organizationBranchDTLList ?? [], val, "keyField")
                        setFieldValue("organizationBranchDTLList", tmporganizationBranchDTLList)

                    } else {
                        setFieldValue("organizationBranchDTLList", [
