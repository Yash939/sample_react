...
const TaskStatusMasterCard = () => {
    ...
    return (
        <Card>
            <CardHeader title={<POSTableFilter qParams={uiProps.queryParams} setQParams={uiProps.setQueryParams} className="searchBar" />}>
                <CardHeaderToolbar>
                    <button
                        type="button"
...
export default TaskStatusMasterCard;