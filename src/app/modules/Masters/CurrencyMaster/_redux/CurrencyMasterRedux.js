...
export const currencyMasterCrud = new Crud("currencyMST")
export const currencyMasterSlice = new BaseSlice(reducerInfo.name, reducerInfo.idFieldName)
export const currencyMasterActions = new Action(currencyMasterCrud, currencyMasterSlice)
